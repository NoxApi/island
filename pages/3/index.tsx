...
//position variable
  ...
  let objpos ={x:-2,y:24,z:6,scale:1.5}
...
//gui
    ...
    // gui.add(rotatedeg,"rotatez").min(-180).max(180).step(1).name("cam-rotation-z")
        gui.add(objpos,"x").min(-7).max(3).step(0.1).name("obj pos-x")
        gui.add(objpos,"y").min(19).max(29).step(0.1).name("obj pos-y")
        gui.add(objpos,"z").min(1).max(11).step(0.1).name("obj pos-z")
