...
export default function Home() {
  ...
  const getsavedo = async () => {
    ...
    // set it to state
    // console.log(result)
    setsavedo(result[4]._document.data.value.mapValue.fields)
  ...
  const update = async () => {
    try {
      setsavedo(null)
      updateDoc(doc(firestore,'object',"syn"),{
...
//gui
 ...
 return () =>{ window.removeEventListener("wheel", handleWheel);
  ...
  object5.position.set(safevalue.x+0.5,safevalue.y,safevalue.z+1)
