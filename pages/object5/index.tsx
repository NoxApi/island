...
export default function Home() {
  ...
  const getsavedo = async () => {
    ...
    // set it to state
    // console.log(result)
    setsavedo(result[2]._document.data.value.mapValue.fields)
  ...
  const update = async () => {
    try {
      setsavedo(null)
      updateDoc(doc(firestore,'object',"egg"),{
...
//gui
 ...
 return () =>{ window.removeEventListener("wheel", handleWheel);
  ...
  object5.position.set(safevalue.x-1.3,safevalue.y,safevalue.z)
