...
//gui
    ...
    gui.add(grouprotate,"rotatex").min(-180).max(180).step(1).name("island rotate x")
    gui.add(grouprotate,"rotatey").min(-180).max(180).step(1).name("island rotate y")
    gui.add(grouprotate,"rotatez").min(-180).max(180).step(1).name("island rotate z")
...
//  window.removeEventListener("mousemove", handleMouseMove);
  ...
  // useHelper(spotlightref4,SpotLightHelper,"red")
